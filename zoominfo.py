...
# OUTPUT_FILENAME = 'zoominfo-salonssearch'
# OUTPUT_FILENAME = 'zoominfo-restaurants-SF'
# OUTPUT_FILENAME = 'zoominfo-restaurants-NY'
# OUTPUT_FILENAME = 'zoominfo-restaurants-LA'
# OUTPUT_FILENAME = 'zoominfo-restaurant-companies'
# OUTPUT_FILENAME = 'salons-ca-companies'
...
searchesRowXpath = "//tr[@class='p-element ng-tns-c468-19 Medium normal not-expansion-row result-row xxsmall-12 hover-cursor p-selectable-row ng-star-inserted']"
...
def searchScrape(browser, company=False):
    ...
    if first:
        ...
        if company:
            request = browser.wait_for_request(searchCompaniesRequestURL)
        else:
            request = browser.wait_for_request(searchPeopleRequestURL)
...
def searchContactScrape(browser):
    ...
    f1 = open(OUTPUT_FILENAME + '-personaldetails', 'w')
    f2 = open(OUTPUT_FILENAME + '-companydetails', 'w')
    f3 = open(OUTPUT_FILENAME + '-contacts', 'w')
